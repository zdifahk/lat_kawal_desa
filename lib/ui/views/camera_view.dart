...
import 'package:kawal_desa2/viewmodels/camera_view_model.dart';
...
class _CameraViewState extends State<CameraView> {
    ...
    builder: (context, model, child) => Scaffold(
      ...
      child: SafeArea(
        child: Column(
          ...
          children: <Widget>[
            Expanded(
              child: _cameraPriviewWidget(model.controller),
              flex: 1,
            ),
            verticalSpaceSmall,
            Row(
  ...
  Widget _cameraPriviewWidget(CameraController controller){
